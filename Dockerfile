...
RUN wget https://nginx.org/packages/centos/7/SRPMS/nginx-1.18.0-2.el7.ngx.src.rpm -O /root/rpmbuild/SRPMS/nginx-1.18.0-2.el7.ngx.src.rpm
RUN wget https://github.com/vozlt/nginx-module-vts/archive/master.zip -O /root/rpmbuild/SOURCES/nginx-module-vts_master.zip
RUN rpm -Uvh /root/rpmbuild/SRPMS/nginx-1.18.0-2.el7.ngx.src.rpm
